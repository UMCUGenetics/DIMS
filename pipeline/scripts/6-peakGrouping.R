...
load(paste(outdir, "5-specpks_all", paste(scanmode, "RData", sep="."), sep="/"))
...
save(outpgrlist, file=paste(paste(outdir, "6-grouping_hmdb", sep="/"), paste(paste(batch, scanmode, sep="_"), "RData", sep="."), sep="/"))

dir.create(paste(outdir, "6-grouping_hmdb_done", sep="/"), showWarnings = FALSE)
save(outlist.grouped, file=paste(paste(outdir, "6-grouping_hmdb_done", sep="/"), paste(paste(batch, scanmode, sep="_"), "RData", sep="."), sep="/"))

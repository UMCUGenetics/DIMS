...
find "$OUTDIR/hmdb_part" -iname "${scanmode}_*" | while read hmdb;
 do
   ...
   qsub -l h_rt=01:00:00 -l h_vmem=8G -N "grouping_$scanmode" -m as -M $MAIL -o $OUTDIR/logs/grouping_hmdb/${scanmode}_${i}.o -e $OUTDIR/logs/grouping_hmdb/${scanmode}_${i}.e $OUTDIR/jobs/peakGrouping_${scanmode}_${i}.sh
 done
...
qsub -l h_rt=00:15:00 -l h_vmem=8G -N "collect1_$scanmode" -hold_jid "grouping_$scanmode" -m as -M $MAIL -o $OUTDIR/logs -e $OUTDIR/logs $OUTDIR/jobs/collectSamplesGroupedHMDB_${scanmode}.sh

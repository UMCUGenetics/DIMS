...
# metadata
LABEL DIMS_R_PACK_VERSION=0.9
LABEL STATUS="ACTIVE"
LABEL DESCRIPTION="This container provides R and R packages for running the DIMS pipeline in stitching (test) mode."
...
RUN R -e 'BiocManager::install(c("mzR", "stringr", "dplyr", "Rcpp"))'

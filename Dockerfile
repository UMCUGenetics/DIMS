...
LABEL DESCRIPTION="This container provides R and R packages for running the DIMS stitching pipeline with gridExtra."
LABEL GITHUB_REPOSITORY="https://github.com/UMCUGenetics/DIMS"
LABEL STATUS="ACTIVE"
LABEL CREATION_DATE="2024-10-16"
LABEL BASE_IMAGE="rocker/tidyverse:4.1.0"
LABEL EXTRA_PACKAGES="xcms, mzR, stringr, dplyr, Rcpp, openxlsx, reshape2, loder, ggplot2, gridExtra"

# install bioconductor packages; their versions according to bioconductor version (v3.14)
RUN R -e 'BiocManager::install(c("Rcpp", "xcms", "mzR", "stringr", "dplyr"))'

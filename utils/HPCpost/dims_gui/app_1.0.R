...
# pscp = "\"C:/Program Files (x86)/Putty/pscp.exe\" -pw eTZ=ef0d -r -p "
# putty = "\"C:/Program Files (x86)/Putty/putty.exe\" -ssh mwillemsen@hpcsubmit.op.umcutrecht.nl -pw eTZ=ef0d -m "
...
pscp = "\"C:/Program Files/PuTTY/PSCP/pscp.exe\" -pw eTZ=ef0d -r -p "
putty = "\"C:/Program Files/PuTTY/putty.exe\" -ssh mwillemsen@hpcsubmit.op.umcutrecht.nl -pw eTZ=ef0d -m "

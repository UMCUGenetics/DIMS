...
# Command Martin
pscp = "\"C:/PuTTY/pscp.exe\" -pw code@131 -r -p "
putty = "\"C:/PuTTY/putty.exe\" -ssh melferink@hpcsubmit.op.umcutrecht.nl -pw code@131 -m "

# Command Hanneke
# pscp = "\"C:/PuTTY/pscp.exe\" -pw eTZ=ef0d -r -p "
# putty = "\"C:/PuTTY/putty.exe\" -ssh hhaijes-siepel@hpcsubmit.op.umcutrecht.nl -pw eTZ=ef0d -m "
